...
filterSettings = '[0:a]volume=0.75[a0];[1:a]volume=1.0[a1];[a0][a1]amix=inputs=2:duration=longest[a]'
audioMap = '-map'
mapSettings ='[a]'
...
def runAudioMixer():
    for sourceFileName in batchDirectoryList:
        ...
        ffCommand = ['ffmpeg', '-i', backGroundMP3File, '-i', secondInput, primaryFilter, filterSettings, audioMap, mapSettings, sourceFileName]
